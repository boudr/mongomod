...
wget "https://github.com/ceeit0/mongomod/releases/download/v0.0.4/gmsv_mongomod_linux.dll" -O ${PWD}/garrysmod/garrysmod/lua/bin/gmsv_mongomod_linux.dll

wget "https://github.com/ceeit0/mongomod/releases/download/v0.0.4/libmongoclient.so" -O ${PWD}/garrysmod/libmongoclient.so
